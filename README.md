...
After opening the web and entering the home page, if the user wants to register for an account, they first need to click on the “Create account” button in the upper right corner of the page to enter the registration process. Username and password are mandatory information, while age and gender are optional. The username cannot be a duplicate of an existing one, otherwise the user will be reminded that “Username already exists”. Users will be automatically redirected to the login page after completion of registration, and will be able to log in by entering their account name and password. If the user does not wish to log in, they can return to the homepage by clicking on the “CoverDraft” logo in the upper left corner. Alternatively, if the user already has an account and would like to log in from the homepage, click on the “Sign in” button in the upper right corner of the page.
