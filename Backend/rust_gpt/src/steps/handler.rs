...
// #[get("/api/final_step")]
// pub async fn handle_final_step(app_data: web::Data<AppState>,) -> HttpResponse {

//     // let user_id = "12345".to_string();
...
#[get("/api/final-step")]
pub async fn handle_final_step(app_data: web::Data<AppState>) -> HttpResponse {
    handle_step(4, None, app_data).await
}
